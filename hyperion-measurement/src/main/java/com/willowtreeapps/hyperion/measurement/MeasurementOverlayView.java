    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (rectSecondary == null) {
            ...
            if (measurementWidthText != null) {
                canvas.save();
                canvas.translate(rectPrimary.centerX() - (measurementWidthText.getWidth() / 2.0f),
            ...
            if (rectPrimary.bottom < rectSecondary.top) {
                ...
                if (measurementHeightText != null) {
                    canvas.save();
                    canvas.translate(rectSecondary.centerX() - measurementHeightText.getWidth() / 2.0f,
                            (rectPrimary.bottom + rectSecondary.top) / 2.0f - (measurementHeightText.getHeight() / 2.0f));
                    measurementHeightText.draw(canvas);
                    canvas.restore();
                }
            }
            if (rectPrimary.right < rectSecondary.left) {
                ...
                if (measurementWidthText != null) {
                    canvas.save();
                    canvas.translate((rectPrimary.right + rectSecondary.left) / 2.0f - (measurementWidthText.getWidth() / 2.0f),
                            rectSecondary.centerY() - measurementWidthText.getHeight() / 2.0f);
                    measurementWidthText.draw(canvas);
                    canvas.restore();
                }
            }
            if (rectSecondary.bottom < rectPrimary.top) {
                ...
                if (measurementHeightText != null) {
                    canvas.save();
                    canvas.translate(rectSecondary.centerX() - measurementHeightText.getWidth() / 2.0f,
                            (rectPrimary.top + rectSecondary.bottom) / 2.0f - (measurementHeightText.getHeight() / 2.0f));
                    measurementHeightText.draw(canvas);
                    canvas.restore();
                }
            }
            if (rectSecondary.right < rectPrimary.left) {
                ...
                if (measurementWidthText != null) {
                    canvas.save();
                    canvas.translate((rectPrimary.left + rectSecondary.right) / 2.0f - (measurementWidthText.getWidth() / 2.0f),
                            rectSecondary.centerY() - measurementWidthText.getHeight() / 2.0f);
                    measurementWidthText.draw(canvas);
                    canvas.restore();
                }
            ...
            if (inside != null && outside != null) {
                ...
                if (measurementLeftText != null) {
                    canvas.save();
                    canvas.translate((outside.left + inside.left) / 2.0f - measurementLeftText.getWidth() / 2.0f,
                            inside.centerY() - measurementLeftText.getHeight() / 2.0f);
                ...
                if (measurementRightText != null) {
                    canvas.save();
                    canvas.translate((outside.right + inside.right) / 2.0f - measurementRightText.getWidth() / 2.0f,
                            inside.centerY() - measurementRightText.getHeight() / 2.0f);
                ...
                if (measurementTopText != null) {
                    canvas.save();
                    canvas.translate(inside.centerX() - measurementTopText.getWidth() / 2.0f,
                            (outside.top + inside.top) / 2.0f - measurementTopText.getHeight() / 2.0f);
                ...
                if (measurementBottomText != null) {
                    canvas.save();
                    canvas.translate(inside.centerX() - measurementBottomText.getWidth() / 2.0f,
                            (outside.bottom + inside.bottom) / 2.0f - measurementBottomText.getHeight() / 2.0f);
