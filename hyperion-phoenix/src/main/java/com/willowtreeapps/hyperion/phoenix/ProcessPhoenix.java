...
public class ProcessPhoenix extends Activity {
    ...
    private static final String KEY_CLEAR_SHARED_PREFS = "phoenix_clear_shared_prefs";
    ...
    public static void triggerRebirth(Context context, Intent... nextIntents) {
        ...
        intent.putExtra(KEY_CLEAR_SHARED_PREFS, options.shouldClearSharedPrefs());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final boolean shouldClearSharedPrefs = intent.getBooleanExtra(KEY_CLEAR_SHARED_PREFS, false);
    ...
    private void clearSharedPreferences() {
        File sharedPreferenceFile = new File(getFilesDir().toString().replace("/files", "") + "/shared_prefs");
