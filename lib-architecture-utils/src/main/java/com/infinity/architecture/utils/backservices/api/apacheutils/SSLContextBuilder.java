...
public class SSLContextBuilder {
     ...
     */
    public SSLContextBuilder loadTrustMaterial(
            final String file) throws NoSuchAlgorithmException, KeyStoreException, CertificateException, IOException {
    ...
    public SSLContextBuilder loadTrustMaterial(
        ...
        Args.notNull(file, "Truststore file");
        return loadTrustMaterial(file.getPath(), storePassword, trustStrategy);
    }
    ...
    public SSLContextBuilder loadKeyMaterial(
        ...
        Args.notNull(file, "Keystore file");
        return loadKeyMaterial(file.getPath(), storePassword, keyPassword, aliasStrategy);
    }
    ...
    private KeyStore loadKeyStore(final String file, final char[] password, final OpenOption... openOptions)
