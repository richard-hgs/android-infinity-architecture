...
public class KeyboardListener implements ViewTreeObserver.OnGlobalLayoutListener {
     ...
     */
    public static void addKeyboardToggleListener(Context context, Window window, SoftKeyboardToggleListener listener) {
        removeKeyboardToggleListener(listener);

        sListenerMap.put(listener, new KeyboardListener(context, window, listener));
    }
    ...
    private KeyboardListener(Context act, Window window, SoftKeyboardToggleListener listener)  {
        mCallback = listener;

        mRootView = ((ViewGroup) window.getDecorView().getRootView()).getChildAt(0);
