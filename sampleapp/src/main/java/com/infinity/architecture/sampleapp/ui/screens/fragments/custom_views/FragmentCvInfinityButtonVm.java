...
@HiltViewModel
public class FragmentCvInfinityButtonVm extends MyBaseFragmentViewModelOpt {

    private final AppApplication appApplication;

    @Inject
    public FragmentCvInfinityButtonVm(@NonNull AppApplication appApplication) {
    ...
    protected void safeConstructor(@NonNull LifecycleOwner lifecycleOwner, @Nullable Bundle fragArgs, @Nullable Bundle actArgs) {
        setActionBar(ActionBarInfo.getInstance(null, appApplication.getString(R.string.cv_title_infinity_button), true, true));
    }
