...
@AndroidEntryPoint
public class FragmentCvInfinityEditText extends MyBaseFragmentOpt {

    @Override
    public Class<? extends BaseFragmentViewModel> screenVmClass() {
        return FragmentCvInfinityEditTextVm.class;
    }

    @Override
    public int screenLayout() {
        return R.layout.fragment_cv_infinity_edit_text;
    }
