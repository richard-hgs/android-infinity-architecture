...
@HiltViewModel
public class FragmentCvInfinityTextInputEditTextVm extends MyBaseFragmentViewModelOpt {

    private final AppApplication appApplication;

    @Inject
    public FragmentCvInfinityTextInputEditTextVm(@NonNull AppApplication appApplication) {
    ...
    protected void safeConstructor(@NonNull LifecycleOwner lifecycleOwner, @Nullable Bundle fragArgs, @Nullable Bundle actArgs) {
        setActionBar(ActionBarInfo.getInstance(null, appApplication.getString(R.string.cv_title_infinity_text_input_edit_text), true, true));
    }
